...
class TestDealerTurn(unittest.TestCase):
    @patch('src.utils.calculator.calculate_deck_value', side_effect=[15, 18, 21])
    ...
    @patch('src.utils.calculator.calculate_deck_value', side_effect=[15, 18, 22])
    ...
    @patch('src.utils.calculator.calculate_deck_value', side_effect=[15, 18, 19])
